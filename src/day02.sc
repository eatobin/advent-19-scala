...
val ic: intcode.IntCode = intcode.IntCode.opCode(intcode.IntCode(output = 0, pointer = 0, memory = updatedMemory(noun = 12)(verb = 2)))
...
val answer2: Int = (for {noun <- Range.inclusive(0, 99)
                         ...
                         candidate: Int = intcode.IntCode.opCode(intcode.IntCode(output = 0, pointer = 0, memory = updatedMemory(noun = noun)(verb = verb))).output
