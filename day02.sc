...
val ic: intcode.IntCode = intcode.IntCode.opCode(intcode.IntCode(input = 0, output = 0, phase = 0, pointer = 0, relativeBase = 0, memory = updatedMemory(noun = 12)(verb = 2), stopped = false, recur = true))
...
val answer2: Int = (for {noun <- Range.inclusive(0, 99)
                         ...
                         candidate: Int = intcode.IntCode.opCode(intcode.IntCode(input = 0, output = 0, phase = 0, pointer = 0, relativeBase = 0, memory = updatedMemory(noun = noun)(verb = verb), stopped = false, recur = true)).memory(0)
