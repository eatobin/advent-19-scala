...
val ic: intcode.IntCode = intcode.IntCode.opCode(intcode.IntCode(input = 0, output = 0, pointer = 0, relativeBase = 0, memory = updatedMemory(noun = 12)(verb = 2)))
...
//                         candidate: Int = intcode.IntCode.opCode(intcode.IntCode(input = 0, output = 0, pointer = 0, relativeBase = 0, memory = updatedMemory(noun = noun)(verb = verb))).memory(0)
